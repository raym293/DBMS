...
\newcommand{\demoimage}[2]{%
    \IfFileExists{#1}{%
        \includegraphics[width=\linewidth,height=8cm,keepaspectratio]{#1}%
    }{%
        \fbox{%
            \parbox[c][5cm][c]{0.92\linewidth}{%
                \centering
                \textbf{Screenshot missing}\\
                \texttt{#1}\\[0.4em]
                #2
            }%
        }%
...
\noindent Place screenshots under \texttt{figures/} using the filenames
referenced below; they will be embedded automatically.

\begin{figure}[htbp]
    \centering
    \demoimage{figures/demo-dashboard.png}{Web dashboard overview}
...
\begin{figure}[htbp]
    \centering
    \demoimage{figures/demo-commits.png}{Commits page}
...
\begin{figure}[htbp]
    \centering
    \demoimage{figures/demo-branches.png}{Branches page}
...
\begin{figure}[htbp]
    \centering
    \demoimage{figures/demo-users.png}{Users page}
...
\begin{figure}[htbp]
    \centering
    \demoimage{figures/demo-cli.png}{CLI terminal session}
...
\noindent\textbf{Note:} Throughout this section, replace
\texttt{<project-ref>} with your Supabase project reference ID, which is
found in your Supabase dashboard under
\textit{Project Settings $\rightarrow$ General $\rightarrow$ Reference ID}
(e.g.\ \texttt{abcdefghijklmnop}).
